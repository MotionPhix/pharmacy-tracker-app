                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative font-bold inline-flex bg-gray-100 items-center px-4 py-2 -ml-px text-sm text-gray-600 border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
